...
function email_invitation(string $toName, string $plan = 'rise', string $gender = 'male', string $customMsg = ''): string {
    ...
    return "<!DOCTYPE html><html lang=\"es\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><title>{$name} — WellCore Fitness</title></head>"
        ...
        . "</tr></table></td></tr>"
        . "<tr><td style=\"padding:48px 40px 36px;background:#111113;border-bottom:1px solid #1e1e22;\">"
        ...
        . "<p style=\"font-family:Arial,Helvetica,sans-serif;font-size:15px;color:rgba(255,255,255,0.7);line-height:1.7;margin:0;\">{$desc}</p></td></tr>"
        ...
        . "</td></tr></table>"
        . "<p style=\"font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#444;margin:16px 0 0 0;\">¿Tienes preguntas? Responde este correo o escríbeme por WhatsApp.</p>"
        . "</td></tr>"
        . "<tr><td style=\"padding:24px 40px;background:#0a0a0a;border-top:1px solid #1e1e22;\">"
